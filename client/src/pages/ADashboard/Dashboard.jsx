  ...
  return (
    <body>
      ...
      <div className="content">
        ...
        <div className="mt-4 d-flex justify-content-center align-items-center" style={{ backgroundColor: "lightskyblue", borderRadius: "80px", height: "80px" }}> <h2>Total Students:  <span className="badge bg-primary rounded-pill">{getTotalStudentsCount()}</span></h2></div>
